# -*- coding: utf-8 -*-
"""Dashboard de Documentos Recibidos 5
...
try:
    ...
    # st.write("Data for Zone Bar Chart (zona_counts):", zona_counts) # Debug print # Removed to reduce clutter
    ...
    # st.write("Total Documents:", total_documents) # Debug print # Removed to reduce clutter
    # st.write("Count of 'Sí' Confirmations:", sí_confirmations_count) # Debug print # Removed to reduce clutter


    sí_percentage = (sí_confirmations_count / total_documents) * 100 if total_documents > 0 else 0
    # st.write("Percentage of 'Sí' Confirmations:", sí_percentage) # Debug print # Removed to reduce clutter
    ...
    st.write("Data for Plaza/Entity Map (plaza_counts):", plaza_counts.head()) # Keep this debug print
    ...
    st.write("Data for Geo Map after merge and dropna (plaza_geo_df):", plaza_geo_df.head()) # Keep this debug print
