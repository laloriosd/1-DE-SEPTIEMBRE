# -*- coding: utf-8 -*-
"""Dashboard de Documentos Recibidos 17
...
try:
    # Load data from the fixed file path - UPDATED PATH
    df_notificaciones = pd.read_excel('nuevoDF3.xlsx')
    ...
    if not df_filtered.empty:
        ...
        # --- Mostrar visualizaciones en Streamlit in a layout suitable for 3 plots ---
        # We have 3 main visualizations: Bar, Gauge, and Pie.
        # We can arrange them in two columns. The bar chart could be in the first column,
    ...
    st.error("Error: Asegúrate de que el archivo 'Latitud y longitud.xlsx' esté en la misma carpeta que el script de Streamlit, y que 'nuevoDF3.xlsx' exista.")
