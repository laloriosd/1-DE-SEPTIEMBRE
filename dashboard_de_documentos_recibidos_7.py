# -*- coding: utf-8 -*-
"""Dashboard de Documentos Recibidos 7
...
if uploaded_file is not None:
    ...
    try:
        ...
        status_counts = df_merged['STATUS'].value_counts().reset_index()
        status_counts.columns = ['STATUS', 'Count']

        fig_pie = go.Figure(data=[go.Pie(labels=status_counts['STATUS'], values=status_counts['Count'], hole=.3,
                                         marker=dict(colors=px.colors.sequential.Reds_r))]) # Use a red color scale
        fig_pie.update_layout(title_text="Distribución de Documentos por Status")
