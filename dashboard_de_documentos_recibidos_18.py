# -*- coding: utf-8 -*-
"""Dashboard de Documentos Recibidos 18
...
try:
    ...
    # Note: TURNADO A is now TURNADO_A due to renaming columns with underscore
    ...
    if not df_filtered.empty:
        ...
        fig_turnado.update_layout(title_text=f"Número de Documentos por Turnado A en {selected_month}, {selected_year}")
